...
**Tier B** — 控制变量实验（n=10，基于 [BFCL](https://gorilla.cs.berkeley.edu/leaderboard.html)、[τ-bench](https://arxiv.org/abs/2406.12045)、[ToolSword](https://arxiv.org/abs/2402.10753)、[MCPToolBench++](https://arxiv.org/abs/2508.07575)）。综合 Δ+36，6 个回归如实记录。[完整方法论](https://github.com/effectorHQ/effector-bench/blob/main/METHODOLOGY.md)。
